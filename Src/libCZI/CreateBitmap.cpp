...
static std::shared_ptr<libCZI::IBitmapData> CreateBitmapFromSubBlockData_JpgXr(
        const void* pv,
        size_t size,
...
static std::shared_ptr<libCZI::IBitmapData> CreateBitmapFromSubBlockData_ZStd0(
        const void* pv,
        size_t size,
        libCZI::PixelType pixelType,
        std::uint32_t width,
...
static std::shared_ptr<libCZI::IBitmapData> CreateBitmapFromSubBlockData_ZStd1(
        const void* pv,
        size_t size,
        libCZI::PixelType pixelType,
        std::uint32_t width,
...
static std::shared_ptr<libCZI::IBitmapData> CreateBitmapFromSubBlockData_Uncompressed(
                                        const void* pv,
                                        size_t size,
                                        libCZI::PixelType pixelType,
                                        std::uint32_t width,
...
static std::shared_ptr<libCZI::IBitmapData> CreateBitmapFromSubBlockData_ChunkedExtensible(
    const void* pv,
    size_t size,
    libCZI::PixelType pixelType,
    std::uint32_t width,
